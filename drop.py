...
title = pygame.image.load('dropstart.png')
game_over = pygame.image.load('GameOver.png')
para = pygame.image.load('parachuter.png')
...
def drawPlayer():
    surface.blit(para, (player['x'], player['y']))
...
def movePlayer():
    ...
    if leftOfPlayerOnPlatform is False and rightOfPlayerOnPlatform is False and (player['y']+player['height'])+player['vy']<windowHeight:
        ...
        while foundPlatformTop is False:
            ...
            elif int(player['y'] + player['height']) - yOffset >0:
                yOffset += 1
            else:
...
while True:
    ...
    if gameStarted is True:
            ...
            surface.blit(game_over, (0, 150))
        
    else:
            surface.blit(title, (0, 150))
